...
jest.mock("@/app/dashboard/financial/poai-ppa/PoaiPpaTableTab", () => ({ PoaiPpaTableTab: () => <div data-testid="table-tab">TableTab</div> }));
jest.mock("@/app/dashboard/financial/poai-ppa/PoaiPpaChartsTab", () => ({ PoaiPpaChartsTab: () => <div data-testid="charts-tab">ChartsTab</div> }));

import PoaiPpaPage from "@/app/dashboard/financial/poai-ppa/page";
