...
import { EditorCanvas } from "@/components/modals/masters/indicators/formulas/components/EditorCanvas";

jest.mock("@/components/modals/masters/indicators/formulas/components/StepChip", () => ({
