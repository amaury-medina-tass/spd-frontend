...
export function AnnualGoalsTab({ variableId }: Props) {
    ...
    const [editingGoal, setEditingGoal] = useState<VariableGoal | null>(null)
    const [goalToDelete, setGoalToDelete] = useState<VariableGoal | null>(null)
    ...
    const handleEditGoal = (goal: VariableGoal) => {
        setEditingGoal(goal)
    ...
    const handleDeleteGoal = (goal: VariableGoal) => {
    ...
    const onSubmit = async (data: FormValues) => {
        ...
        try {
            if (editingGoal) {
                await patch(`${endpoints.masters.variableGoals}/${editingGoal.id}`, {
                    value: data.value
                })
    ...
    const onConfirmDelete = async () => {
        ...
        setDeleting(true)
        try {
            await del(`${endpoints.masters.variableGoals}/${goalToDelete.id}`)
