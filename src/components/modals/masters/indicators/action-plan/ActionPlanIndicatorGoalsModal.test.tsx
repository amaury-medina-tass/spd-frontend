...
import { ActionPlanIndicatorGoalsModal } from "./ActionPlanIndicatorGoalsModal";

jest.mock("./goals/ActionPlanAnnualGoalsTab", () => ({
  ActionPlanAnnualGoalsTab: () => <div>AnnualGoalsTab</div>,
}));
jest.mock("./goals/ActionPlanQuadrenniumGoalsTab", () => ({
