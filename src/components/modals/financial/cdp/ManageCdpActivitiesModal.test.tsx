...
import { ManageCdpActivitiesModal } from "./ManageCdpActivitiesModal";

jest.mock("./activities/AssociatedCdpActivitiesTab", () => ({
  AssociatedCdpActivitiesTab: ({ positionId }: any) => (
    <div data-testid="associated-tab">AssociatedTab-{positionId}</div>
  ),
}));
jest.mock("./activities/AvailableCdpActivitiesTab", () => ({
