...
jest.mock("@/components/modals/masters/indicators/action-plan/projects/AssociatedProjectsTab", () => ({
  AssociatedProjectsTab: () => <div>AssociatedProjectsTab</div>,
}));
jest.mock("@/components/modals/masters/indicators/action-plan/projects/AvailableProjectsTab", () => ({
