...
import { StepChip } from "@/components/modals/masters/indicators/formulas/components/StepChip";

jest.mock("@/components/modals/masters/indicators/formulas/utils/helpers", () => ({
