...
import { ManageDetailedActivitiesModal } from "./ManageDetailedActivitiesModal";

jest.mock("./tabs/AssociatedDetailedActivitiesTab", () => ({
  AssociatedDetailedActivitiesTab: () => <div>AssociatedTab</div>,
}));
jest.mock("./tabs/AvailableDetailedActivitiesTab", () => ({
