...
jest.mock("@/app/dashboard/masters/activities/MGAActivitiesTab", () => ({ MGAActivitiesTab: () => <div data-testid="mga-tab">MGA</div> }));
jest.mock("@/app/dashboard/masters/activities/DetailedActivitiesTab", () => ({ DetailedActivitiesTab: () => <div data-testid="detailed-tab">Detailed</div> }));

import MastersActivitiesPage from "@/app/dashboard/masters/activities/page";
