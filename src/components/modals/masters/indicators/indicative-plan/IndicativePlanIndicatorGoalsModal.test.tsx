...
import { IndicativePlanIndicatorGoalsModal } from "./IndicativePlanIndicatorGoalsModal";

jest.mock("./goals/IndicativeAnnualGoalsTab", () => ({
  IndicativeAnnualGoalsTab: () => <div>AnnualGoalsTab</div>,
}));
jest.mock("./goals/IndicativeQuadrenniumGoalsTab", () => ({
